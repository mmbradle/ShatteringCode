...
class CoffeeFlavorFactory {
	private Map<String, CoffeeFlavor> flavorCache = new HashMap<String, CoffeeFlavor>();

	public CoffeeFlavor getCoffeeFlavor(String flavorName) {
		CoffeeFlavor flavor = flavorCache.get(flavorName);
		if (flavor == null) {
			flavor = new CoffeeFlavor(flavorName);
			flavorCache.put(flavorName, flavor);
		}
		return flavor;
	}

	public int getTotalCoffeeFlavorsMade() {
		return flavorCache.size();
	}
}
