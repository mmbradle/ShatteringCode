...
class NutritionFacts {
	...
	public static class NutritionFactsBuilder {
		...
		public NutritionFactsBuilder calories(int val) { calories = val; return this; }
		...
		public NutritionFactsBuilder carbs(int val) { carbs = val; return this; }
...
public class Builder_Bloch {
	public static void main(String... args) {
		NutritionFactsBuilder builder = new NutritionFactsBuilder(3, 4).calories(5).fat(6);
